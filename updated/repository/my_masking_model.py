...
if __name__=='__main__':
    sentences = ["चूँकि/क्योंकि *त्यद् ग्रह [MASK] ही जीवन पाया जाता है।","वायुमण्डल [MASK] गैसें, जलवाष्प और धूलकण भी पा गये जाते हैं।"]
    results1= process_multiple_sentences(sentences)
